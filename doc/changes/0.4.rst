...
- Update the documentation with :ref:`bibtex:bibtex format`, :ref:`cli:command-line` and :ref:`configuration:configuration`
...
- Separate execution of ``check_bib_database()`` and ``clean_bib_database()``
