...
- Add I/O to load and save BibTex files
- Add ``check_bib_database()`` to prevent duplicate entries in a BibTex file
- Add ``clean_bib_database()`` to clean-up and alphabetically order enries in a BibTex file
